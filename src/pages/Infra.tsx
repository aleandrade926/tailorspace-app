...
const InfraPage = () => {
  ...
  return (
    <div className="infra-container">
        ...
        <div className="infra-linhas-content">
          ...
          <div className="infra-cards-grid">
            ...
            <div className="infra-card">
              ...
              <p>
                Preparação e regularização de ativos imobiliários com grande capacidade elétrica para suportar as demandas da logística autônoma: pontos de recarga de drones de carga e vertipontos para veículos elétricos de decolagem vertical (eVTOL).
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="infra-tax-highlight" style={{ padding: '3.5rem 2rem', backgroundColor: '#0a101d', borderTop: '1px solid rgba(212,175,55,0.1)' }}>
        <div className="infra-tax-content" style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '16px', padding: '2.5rem', background: 'linear-gradient(180deg, rgba(255,255,255,0.02) 0%, transparent 100%)' }}>
          <h3 style={{ color: '#D4AF37', fontSize: '1.45rem', fontWeight: 'bold', marginBottom: '1rem' }}>Estrutura fiscal e regulatória desde a origem</h3>
          <p style={{ color: '#cbd5e1', fontSize: '1.18rem', lineHeight: '1.65', marginBottom: '1.5rem' }}>
          ...
          <span style={{ display: 'inline-block', fontSize: '1rem', color: '#94a3b8', fontStyle: 'italic', borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '1rem', width: '80%' }}>
